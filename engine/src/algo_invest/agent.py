...
from algo_invest.llm import ILlmProvider, LlmRequest
from algo_invest.models import Account, Agent as AgentModel, Instrument
...
async def ensure_default_agent(
    ...
    *,
    ...
    from algo_invest.models import new_id
